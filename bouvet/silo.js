	...
	$.fn.smint = function( options ) {
		...
		return $('.smint a').each( function(index) {
        	...
        	$(this).on('click', function(e){
				...
				var goTo =  $('div.'+ id).offset().top + selectorHeight + 20;
              //console.log("goTo: " + goTo + " -- selectorHeight :"  + selectorHeight);
...
//   $("#murphy").on('click', function() {
//       $("#partial").toggleClass("hide show");
//       $("#whole").toggleClass("hide show");
